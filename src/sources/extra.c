...
void setBit(my_decimal* decimal, unsigned int bit_value,
...
/// @brief | Устанавливает значение bit_value указанного бита bit_position в
/// числе decimal|
/// @param dst -  указатель на число my_big_decimal
/// @param bit_value -  значение бита uint
/// @param bit_position -  номер бита uint
...
/// @param decimal -  число my_decimal
/// @param bit_position -  номер бита uint
/// @return 0 или 1
...
/// @brief | Возвращает значение указанного бита bit_position в числе decimal |
/// @param decimal -  число my_big_decimal
/// @param bit_position -  номер бита uint
/// @return 0 или 1
...
/// @param decimal -  указатель на число my_decimal
...
/// @brief | Устанавливает знак числа sign в числе decimal |
/// @param decimal -  указатель на число my_big_decimal
/// @param sign -  знак числа uint 0 или 1
...
/// @param big_decimal - указатель на число my_big_decimal
/// @return
/// 0 - OK;
/// 1 - ошибка инициализации
...
/// @return scale для записи в my_decimal (int)
...
/// @param fnum - указатель на число double
/// @param  scale - указатель на scale (int) числа my_decimal
...
/// @param decimal - указатель на число my_decimal
/// @param scale_decimal - scale (uint) числа my_decimal
...
/// @brief | Записывает значение scale_decimal в число decimal |
/// @param decimal - указатель на число my_big_decimal
/// @param scale_decimal - scale (uint) числа my_big_decimal
...
/// @param decimal - указатель на число my_decimal
/// @param scale_decimal - scale (int) числа my_decimal
/// @return
/// 0 - OK;
/// 1 - ошибка записи
...
/// @param decimal - указатель число my_decimal
...
/// @brief | Преобразование my_decimal в my_big_decimal |
...
/// @brief | Преобразование my_big_decimal в my_decimal |
/// @param src - число my_big_decimal
/// @param dst - указатель на число my_decimal
/// @return
/// 0 - OK;
...
/// @brief | Банковское округление числа my_big_decimal |
/// @param decimal - указатель на число my_big_decimal
/// @param remainder - число my_big_decimal
void bankRounding(my_big_decimal* decimal, my_big_decimal remainder) {
  if (decimal != NULL) {
    ...
    my_big_decimal half_divisor = {{5, 0, 0, 0, 0, 0, 0, 0}};
    ...
    my_big_decimal unit = {{1, 0, 0, 0, 0, 0, 0, 0}};
...
/// @brief | Умножение двух чисел my_big_decimal |
/// @param value_1 -  число my_big_decimal
/// @param value_2 -  число my_big_decimal
/// @param result -  указатель на my_big_decimal
...
void mulDecimalBy10(my_decimal* decimal) {
  if (decimal != NULL) {
    my_decimal value_10 = {{10, 0, 0, 0}};
    my_mul(*decimal, value_10, decimal);
    unsigned int scale = getScale(*decimal);
...
void mulBigDecimalBy10(my_big_decimal* decimal) {
  if (decimal != NULL) {
    my_big_decimal value_10 = {{10, 0, 0, 0, 0, 0, 0, 0}};
...
/// @brief | Делит два числа my_big_decimal |
/// @param value_1 - число my_big_decimal
/// @param value_2 - число my_big_decimal
/// @param result - указатель на число my_big_decimal
/// @param remainder - указатель на число my_big_decimal
...
/// @brief | Возвращает целую часть и остаток деления двух чисел my_big_decimal
/// |
/// @param value_1 - число my_big_decimal
/// @param value_2 - число my_big_decimal
/// @param result - указатель на число my_big_decimal
...
void divBigDecimalBy10(my_big_decimal* decimal, my_big_decimal* remainder) {
  if (decimal != NULL && remainder != NULL) {
    my_big_decimal divident = *decimal;
    my_big_decimal divisor = {{10, 0, 0, 0, 0, 0, 0, 0}};
...
/// @brief | Сложение двух чисел my_big_decimal |
/// @param value_1 - число my_big_decimal
/// @param value_2 - число my_big_decimal
/// @param result - указатель на число my_big_decimal
...
/// @brief | Вычитание двух чисел my_big_decimal |
/// @param value_1 - число my_big_decimal
/// @param value_2 - число my_big_decimal
/// @param result - указатель на число my_big_decimal
...
void getTwosComplementBigDecimal(my_big_decimal src, my_big_decimal* dst) {
  if (dst != NULL) {
    ...
    my_big_decimal additional_unit = {{1, 0, 0, 0, 0, 0, 0, 0}};
...
/// @param src - указатель на число my_big_decimal
